...
/**
 * Add extra ENV vars by environment
 */
...
$wp_envars_config = 'wp-config/wp-envars-' . ENVIRONMENT . '.php'; 

// Check to see if the configuration file for the environment exists
if (file_exists(__DIR__ . '/' . $wp_envars_config)) {
  require_once($wp_envars_config);
} else {
